...
class AppRepositoryImpl @Inject constructor(
    ...
    class AppRepositoryImpl @Inject constructor(
        ...
        override suspend fun insertOrderWithItems(
            order: OrderEntity,
        ...
        // Warehouse operations
        override fun getAllWarehouses(): Flow<List<WarehouseEntity>> =
        ...
        // Stock operations
        override fun getStockForProductInWarehouse(
            productId: String,
            warehouseId: String
        ): Flow<StockAtWarehouseEntity?> =
