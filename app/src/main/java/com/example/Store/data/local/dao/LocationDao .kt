...
interface ProductLocationDao {
    ...
    fun getProductQuantityAtSpot(productId: String, locationId: String, aisle: String?, shelf: String?, level: String?): Flow<Int?>
    ...
    suspend fun findProductLocation(productId: String, locationId: String, aisle: String?, shelf: String?, level: String?): ProductLocationEntity?
